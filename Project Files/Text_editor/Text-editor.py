...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        filemenu.add_command(label = 'New File', command = self.newDoc)
        filemenu.add_command(label = 'Save File', command = self.saveDoc)
        filemenu.add_command(label = 'Open File', command = self.openDoc)
